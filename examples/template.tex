...
\cvitem{}{A software developer with 8+ years of experience building performant and robust web applications with insight into the loyalty and finance industries and payment systems. Vim and Dvorak user and a lifelong learner.
\newline{}
\begin{itemize}
...
\item Improved type safety within the merchant profile systems and wrote DSL compilers to generate type signatures for internal gems that did not have type signatures.
\end{itemize}}
\bigskip
\cvitem{}{\textbf{Technologies Used: }Ruby on Rails, Sorbet, Typescript, React}
...
\item Onboarded and trained many new hires and brought them upto speed.
\end{itemize}}
\bigskip
\cvitem{}{\textbf{Technologies Used: }Ruby on Rails, PostgreSQL, Typescript, React, EmberJS}

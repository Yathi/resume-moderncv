...
\cvitem{}{A software developer with 8+ years of experience building performant and robust web applications with insight into the loyalty and finance industries. Vim and Dvorak user and a lifelong learner.
\newline{}
\begin{itemize}
\item Ruby on Rails, Typescript, Python, React, EmberJS
\item Enthusiastic about functional programming paradigms and dabbled with Haskell, Elixir and Elm
...
\cventry{2016--Present}{Senior Full Stack Developer}{\textsc{RewardOps}}{Toronto}{ON}{
\begin{itemize}
\item Architected and implemented most of the Reward management system used by program managers at RewardOps and its clients
\item Implemented a filter string parser as a standalone JS library. This library is capable of recursively parsing filter definitions with different combinations of conditions and it also has methods to update the filter strings. These filter strings are used throughout the system for different rules, such as: pricing, item permissions and item promotions
\item Was part of various program launches including Aeroplan, Airmiles and US Bank Rewards and implemented an asynchronous event driven order placement flow which considerably sped up the order creation speeds and API response times.
\item Rearchitected and improved the order refund and cancellation system using event-sourcing techniques
\item Refactored and implemented the supplier fulfillment flow
\item Built third party integrations with many of RewardOps's clients and suppliers
...
\item Onboarded and trained most of the current frontend team
\end{itemize}}
\bigskip
\cvitem{}{\textbf{Technologies Used: }Ruby on Rails, Rspec, Minitest, PostgreSQL, Javascript, Typescript, React, EmberJS, Git}
...
\cvitem{Video Games}{Mainly DotA and Guild Wars. Currently playing AOE4}
\cvitem{Vim}{Love tinkering with it and trying to get better.}
